...
const Education = ({ educationInfo, editEducationItem, setEducationInfo, addEducationItem, setEditEducationItem, setAddEducationItem, saveEducationEdit, removeEducation, addEducation }) => {
